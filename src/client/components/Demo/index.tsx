...
const Button = styled.button`
    @tailwind font-semibold text-sm px-3 py-2 rounded-lg bg-green-500 shadow-lg hover:bg-green-400 hover:-translate-y-0.5 text-white transform transition uppercase flex-grow-0;
`;
